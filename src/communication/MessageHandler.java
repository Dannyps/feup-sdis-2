...
public class MessageHandler implements Runnable {
	...
	public String parseMessage(byte[] readData) {
		...
		parseMessageContent(request, firstLine, secondLine, thirdLine);

		return executeMessage(firstLine, secondLine, thirdLine, request);
	}

	private void parseMessageContent(String request, String[] firstLine, String[] secondLine, String thirdLine) {
